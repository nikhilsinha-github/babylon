...
class EditUser extends StatefulWidget {
  ...
  @override
  _EditUserState createState() => _EditUserState(this.agentUserId);
}
...
class _EditUserState extends State<EditUser> {
  ...
  getSingleUser() async {
    ...
    var request = http.Request(
      'GET',
      Uri.parse(
          'http://ibeapi.mobile.it4t.in/api/company/users?AgentUserId=$agentUserId'),
    );
